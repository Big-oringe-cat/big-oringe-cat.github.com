<?php
/* Smarty version 3.1.29, created on 2017-10-09 10:02:27
  from "/usr/share/zabbix/oneoaas/templates/graphtree/graphtree.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59dad8b36c1bc0_36292634',
  'file_dependency' => 
  array (
    '4ad4bdaaa77e43e1632b352cb0e75d831f8c52b4' => 
    array (
      0 => '/usr/share/zabbix/oneoaas/templates/graphtree/graphtree.tpl',
      1 => 1507514459,
      2 => 'file',
    ),
  ),
...
function content_59dad8b36c1bc0_36292634 ($_smarty_tpl) {
    ...
    <div class="main_container">
        <div class="row">
			...
			<div class="pull-right">
                            <a class="btn btn-dark" href="../zabbix.php?action=dashboard.view">进入管理界面</a>
                        </div>
                    </h3>
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                <div class="row">
                                    <div class="col-md-55">
                                        <span>开始时间</span>
                                        <input id="starttime" name="starttime" type="text" class="form-control datepicker" value="<?php echo $_smarty_tpl->tpl_vars['timeline']->value['starttime'];?>
" placeholder="">
                                    </div>
                                    <div class="col-md-55">
                                        <span>结束时间</span>
                                        <input id="endtime" name="endtime" type="text" class="form-control datepicker" value="<?php echo $_smarty_tpl->tpl_vars['timeline']->value['endtime'];?>
" placeholder="">
                                    </div>
                                    <div class="col-md-55">
                                        <span>搜索</span>
...
<?php echo '<script'; ?>
 src="../oneoaas/assets/js/jquery-1.11.3.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../oneoaas/assets/js/jquery.datetimepicker.full.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../oneoaas/assets/js/jquery.simplePagination.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../oneoaas/assets/js/jquery.ztree.all.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="../oneoaas/assets/js/oneoaas.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>

    var timeline = {
        stime:'<?php echo $_smarty_tpl->tpl_vars['timeline']->value['stime'];?>
',
        period:'<?php echo $_smarty_tpl->tpl_vars['timeline']->value['period'];?>
',
        etime:'<?php echo $_smarty_tpl->tpl_vars['timeline']->value['etime'];?>
'
    };
            ...
            if(data.content.values.length > 0){
                ...
                jQuery.each(data.content.values,function(idx,ctx){
                    table.append('<tr>' +
                            ...
                            '<td>'+ ctx.value +'</td>'+
                            '<td><a href="../history.php?action=showvalues&period=86400&itemids[]='+ ctx.itemid+'" target="_blank" rel="noopener noreferrer">查看历史</a></td>'+
                            '</tr>');
                });
