...
function zbx_setcookie($name, $value, $time = null) {
	...
	setcookie($name, $value, isset($time) ? $time : 0, '/oneoaas', null);
	setcookie($name, $value, isset($time) ? $time : 0, '/oneoaas/api', null, HTTPS);
	$_COOKIE[$name] = $value;
}
